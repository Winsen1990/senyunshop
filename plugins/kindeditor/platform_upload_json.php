...
if (empty($_FILES) === false) {
    ...
    $recommend_width = isset($_GET['width']) ? intval($_GET['width']) : 0;
    $recommend_height = isset($_GET['height']) ? intval($_GET['height']) : 0;
    if( $pic_width < $recommend_width && $pic_height < $recommend_height ) {
