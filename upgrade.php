...
$sql[] = 'alter table '.$db->table('cart').' add `relate_product_sn` varchar(255) not null default \'\' comment \'赠品依赖产品\'';
...
$sql[] = 'alter table '.$db->table('order_detail').' add `relate_product_sn` varchar(255) not null default \'\' comment \'赠品依赖产品\'';
$sql[] = 'alter table '.$db->table('order_detail').' add `relate_premark` varchar(255) comment \'赠品依据\'';
