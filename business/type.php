...
if( 'add' == $opera ) {
    if( !check_purview('pur_type_add', $_SESSION['business_purview']) ) {
...
if( 'edit' == $opera ) {
    if( !check_purview('pur_type_edit', $_SESSION['business_purview']) ) {
        show_system_message('权限不足', array());
        exit;
    }
...
if( 'view' == $act ) {
    if( !check_purview('pur_type_view', $_SESSION['business_purview']) ) {
        show_system_message('权限不足', array());
        exit;
    }
...
if( 'delete' == $act ) {
    if( !check_purview('pur_type_del', $_SESSION['business_purview']) ) {
        show_system_message('权限不足', array());
        exit;
    }
    $id = intval(getGET('id'));
