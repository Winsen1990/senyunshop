...
if('edit' == $opera)
{
    ...
    if(!check_purview('pur_adpos_edit', $_SESSION['business_purview']))
    {
        $response['msg'] = '没有操作权限';
...
if('add' == $opera)
{
    ...
    if(!check_purview('pur_adpos_add', $_SESSION['business_purview']))
    {
        $response['msg'] = '没有操作权限';
        echo json_encode($response);
        exit;
...
if('view' == $act)
{
    if(!check_purview('pur_adpos_view', $_SESSION['business_purview']))
    {
...
if('delete' == $act)
{
    if( !check_purview('pur_adpos_del', $_SESSION['business_purview']) ) {
        show_system_message('权限不足');
        exit;
    }
